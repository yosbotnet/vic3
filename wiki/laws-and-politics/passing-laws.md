...
19. **Where clout comes from: job sets the IG, wealth sets the power.** A pop's *job* determines which Interest Group it backs (its political alignment); its *wealth* determines how much political power it pours into that IG (its clout contribution) — so rich pops outweigh poor pops by default. Suffrage/voting laws flatten that disparity: the more suffrage you grant, the more each individual's vote counts relative to raw wealth. Even at universal suffrage wealth still matters (abstracted as the rich lobbying, buying ads, etc.). Decision rule: to shift an IG's clout you can either change *who works* (the job mix, via buildings and PMs) or change *how much votes count* (suffrage law) — expanding suffrage is the lever that dilutes a wealthy opposing IG without touching the economy (2025 comprehensive tutorial, [36:00]).

20. **IG approval applies country-wide buffs and debuffs, not just a Stall multiplier.** Beyond its Stall-chance weight, each IG grants nationwide modifiers when it approves and applies nationwide debuffs when it disapproves. A disapproving Church, for example, applies an education-access debuff that lowers literacy across the whole nation (education access is how pops gain literacy); at 5 approval the Church grants extra authority and at 10 approval extra birth rate. Each IG has its own buff/debuff set. Decision rule: read an IG's approval thresholds, not just its clout — a structurally weak IG you keep angry can still quietly tax your literacy, authority, or birth rate, so it is sometimes worth appeasing an IG you don't need for *votes* purely for its country-wide buff (2025 comprehensive tutorial, [38:01]).

21. **Legitimacy sources.** Legitimacy is derived from your Distribution-of-Power (government) laws and related factors: whether you hold elections, whether the ruler's IG is in government and the government's ideology matches the ruler's, your tax level, and a handful of others. Under autocracy most legitimacy comes from the government matching the ruling monarch's IG/ideology — a Burgundy whose king is petite-bourgeois maximises legitimacy by putting just the petite bourgeoisie in charge. Voting-law nations are more complicated. Decision rule: under autocracy, build the government around the monarch's IG; under elections, stop hand-optimising and use the reform-government button (item 22) (2025 comprehensive tutorial, [42:00]).

22. **Legitimacy effects, and the reform-government button.** High legitimacy = faster law changes and (chiefly) more loyalist generation; low legitimacy = IG-approval losses, slower law changes, and more radicals. Because *every* government change gains radicals and loses loyalists, do not re-form the government over and over by hand-swapping IGs. Instead click **reform government**, which presents the three most-legitimate governments you can form right now, and pick from that list. Decision rule: treat government composition as a small number of deliberate moves, not constant fiddling — each swap is paid for in radicals and lost loyalists, so let the reform-government button surface the legitimate options rather than chasing legitimacy manually (the Belgium run shows the cost of mistiming this — a legitimacy collapse mid-vote, salvaged with the reform-government move; see [Belgium: Conquer, Colonize, React](../case-studies/belgium-conquer-colonize-react.md)) (2025 comprehensive tutorial, [42:31]).
